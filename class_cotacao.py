...
#VALOR VARIÁVEL, ESCOLHA DO CLIENTE
    def dolar2(self, meses):
        self.md = round((meses*self.d3)/3,3)
#VALOR VARIÁVEL, ESCOLHA DO CLIENTE  
    def euro2(self, meses):
        self.me = round((meses*self.e3)/3,3)
#VALOR VARIÁVEL, ESCOLHA DO CLIENTE
    def libra2(self, meses):
        self.ml = round((meses*self.l3)/3,3)
#VALOR VARIÁVEL, ESCOLHA DO CLIENTE
    def bitcoin2(self, meses):
        self.mb = round((meses*self.b3)/3,3)
#VALOR VARIÁVEL, ESCOLHA DO CLIENTE
    def ethereum2(self, meses):
        self.met = round((meses*self.et3)/3,3)