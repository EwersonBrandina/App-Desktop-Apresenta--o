...
# Botão de voltar
fr4_bt6 = Button(fr4, bd=0, image=fr4_img_14, command=lambda: [fr4.grid_remove(),fr2.grid(), mostrar_saldo(),root.geometry("1289x600+310+153")])
...
# Botão de voltar
fr5_bt6 = Button(fr5, bd=0, image=fr4_img_14, command=lambda: [fr5.grid_remove(),fr2.grid(), mostrar_saldo(),root.geometry("1289x600+310+153")])
